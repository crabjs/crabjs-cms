	...
	module.class = {
		...
		backend_menu: {
			...
			menu: [
				{
					title: "Tạo điểm danh",
					link: `/${__config.admin_prefix}/ilearn/class/attendance/create`,
					ref: 'ILEARN_attendance_create'
				}, {
					title: "Danh sách điểm danh",
					link: `/${__config.admin_prefix}/ilearn/class/attendance`,
					ref: 'ILEARN_list_attendance'
				}, {
			...
			{
				name: 'ILEARN_attendance_create',
				title: 'Tạo điểm danh'
			}, {
				name: 'ILEARN_list_attendance',
				title: 'Danh sách điểm danh'
			}, {
				name: 'ILEARN_view_attendance',
				title: 'Xem chi tiết điểm danh'
			}, {
				name: 'ILEARN_update_attendance',
			...
			},
			{
				...
				name: 'ILEARN_update_class',
				title: "Sửa, cập nhật thông tin lớp học"
			}, {
